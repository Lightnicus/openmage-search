		...
		try {
			...
			foreach ($productCollection as $product) {
				...
				if ($product->getTypeId() == Mage_Catalog_Model_Product_Type::TYPE_BUNDLE) {
					list($minimalPrice, $maximalPrice) = $product->getPriceModel()->getTotalPrices($product);

					$payload->setData('min_price', (float) $minimalPrice);
